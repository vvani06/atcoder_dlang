  ...
  auto solve() {
    auto subSolve() {
      ...
      void dfs(int cur, int pre, int step) {
        // if (visited[cur]) {
        //   // if (looped[cur]) {
        //     // injected to other loop
        //   } else {
        //     // injected to other route
        //   }
        //   return;
        // }

        if (step == K || routed[cur]) {
          rbt.insert(A[cur]);
          ans = min(ans, rbt.back);
          rbt.removeKey(A[cur]);
          return;
        }
