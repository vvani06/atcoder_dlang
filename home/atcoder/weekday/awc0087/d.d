...
void problem() {
  ...
  auto solve() {
    auto posi = A.filter!"a > 0".array.sort!"a > b";
    auto nega = A.filter!"a < 0".map!"-a".array.sort!"a > b";

    long ans;
    foreach(chunk; posi.chunks(K)) ans += chunk.front;
    foreach(chunk; nega.chunks(K)) ans += chunk.front;
