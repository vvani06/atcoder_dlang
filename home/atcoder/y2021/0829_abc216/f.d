...
void problem() {
  ...
  auto solve() {
    long[] X;
    long[] Y;
    foreach(a; A.enumerate.array.multiSort!("a.value < b.value", (a, b) => B[a.index] < B[b.index])) {
      X ~= a.value;
      Y ~= B[a.index];
    }
    ...
    auto dp = new long[](5001);
    auto preDp = new long[](5001);
    long ans;
