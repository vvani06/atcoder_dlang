...
void problem() {
  auto S = scan!string(31);

  auto solve() {
    enum A = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
    enum B = "NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm";
    foreach(s; S) {
      s.map!(c => B[A.countUntil(c)]).array.writeln;
    }
  }
