...
void problem() {
  ...
  auto solve() {
    auto deltas = S.map!"a == 'A' ? 1 : a == 'B' ? -1 : 0".array;
    auto acc = 0 ~ deltas.cumulativeFold!"a + b".array;

    auto segTree = SegTree!("a + b", long)(0L.repeat(N * 3).array);
    foreach(a; acc) {
      segTree.add(a + N, 1L);
    }
